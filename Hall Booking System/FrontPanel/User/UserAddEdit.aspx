<%@ Page Title="" Language="C#" MasterPageFile="~/Content/FrontPanel/FrontPanel.master" AutoEventWireup="true" CodeFile="UserAddEdit.aspx.cs" Inherits="FrontPanel_User_UserAddEdit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPageNavigation" runat="Server">
    <li class="breadcrumb-item"><a href='<%=ResolveClientUrl("~/FrontPanel/User/UserHome.aspx") %>'>UserProfile</a></li>
    <li class="breadcrumb-item active">UserProfileEdit</li>
</asp:Content>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#delete" role="tab">Delete Account</a>
                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvUsername" runat="server"
                                        ...
                                        ControlToValidate="txtUsername" ValidationGroup="Save" />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <small><a href='<%=ResolveClientUrl("~/FrontPanel/Authorization/UserResetPassword.aspx") %>'>Forgot your password?</a></small>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <asp:Label ID="lblErrorDelete" runat="server" CssClass="text-danger" EnableViewState="false" />
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label>Give Some Reason<span class="text-danger">*</span></label>
                                <asp:TextBox ID="txtReason" runat="server" CssClass="form-control col-md-6" TextMode="MultiLine" Height="150"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvtxtReason" runat="server"
                                    ErrorMessage="Please give reason"
                                    CssClass="text-danger" SetFocusOnError="true" Display="Dynamic"
                                    ControlToValidate="txtReason" ValidationGroup="Delete" />
                            </div>
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <asp:Button ID="btnDelete" runat="server" Text="Delete" ValidationGroup="Delete" CssClass="btn btn-primary mr-1" OnClick="btnDelete_Click" />
                                    <asp:Button ID="btnCancelDeleteAccount" runat="server" Text="Back" CssClass="btn btn-danger" OnClick="btnCancel_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
