<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserRegistration.aspx.cs" Inherits="FrontPanel_Registration_UserRegistration" %>
                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <p class="lead">
                                More than 10k+ daily users active in our website
                            </p>
                        </div>
                                ...
                                <div class="m-sm-4">
                                    <form id="form1" runat="server">
                                        <div class="form-group">
                                            <label><i class="fa fa-user"></i>&nbsp;Username<span class="text-danger">&nbsp;*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label><i class="fa fa-lock"></i>&nbsp;Password<span class="text-danger">&nbsp;*</span></label>
                                        ...
                                        <div class="text-center mt-3">
                                            <asp:Button ID="btnSignUp" runat="server" CssClass="btn btn-lg btn-primary" Text="Sign Up" ValidationGroup="Login" OnClick="btnSignUp_Click" />
                                        </div>
                                        <div class="text-center mt-2">
                                            <asp:Label ID="lblErrorMessage" runat="server" CssClass="text-danger"></asp:Label>
                                        </div>
                                        <div class="text-center mt-2">
                                            Already account?&nbsp;<a href='<%=ResolveClientUrl("~/FrontPanel/Authorization/UserLogin.aspx") %>'>SignIn</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
