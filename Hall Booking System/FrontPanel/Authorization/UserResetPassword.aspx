<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserResetPassword.aspx.cs" Inherits="FrontPanel_Authorization_UserResetPassword" %>
                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <form id="form1" runat="server">
                                        ...
                                        <div class="text-center mt-2">
                                            Go to&nbsp;<a href='<%=ResolveClientUrl("~/FrontPanel/Authorization/UserLogin.aspx") %>'>SignIn</a>&nbsp;Page
                                        </div>
                                    </form>
                                </div>
                            </div>
