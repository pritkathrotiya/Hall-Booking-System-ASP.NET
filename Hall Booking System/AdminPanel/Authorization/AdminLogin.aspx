<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" Inherits="AdminPanel_Login_AdminLogin" %>
                                    ...
                                    <form id="form1" runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="float-right">
                                                <a href='<%=ResolveClientUrl("~/AdminPanel/Authorization/AdminResetPassword.aspx") %>'>Forgot password?</a>
                                            </small>
                                        </div>
                                        <div>
                                        ...
                                        <div class="text-center mt-3">
                                            <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-lg btn-primary" Text="Sign in" ValidationGroup="Login" OnClick="login_Click"/>
                                        </div>
