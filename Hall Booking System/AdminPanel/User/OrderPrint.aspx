<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="OrderPrint.aspx.cs" Inherits="AdminPanel_User_OrderPrint" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPageNavigation" runat="Server">
    ...
    <li class="breadcrumb-item"><a href='<%=ResolveClientUrl("~/AdminPanel/User/OrderList.aspx") %>'>Order List</a></li>
            ...
            <div class="card">
                <div class="card-body m-sm-3 m-md-5">
                    ...
                    <div class="text-center">
                        ...
                        <a href='<%=ResolveClientUrl("~/AdminPanel/User/OrderList.aspx") %>' class="btn btn-danger">Back</a>
                    </div>
                </div>
            </div>
        </div>
