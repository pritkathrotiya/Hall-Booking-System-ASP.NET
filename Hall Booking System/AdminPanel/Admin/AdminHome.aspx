<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="AdminHome.aspx.cs" Inherits="AdminPanel_Admin_AdminHome" %>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 custom-align-userImg">
                            <asp:Image ID="imgAdminPhoto" runat="server" CssClass="rounded-circle img-responsive" Width="176" Height="176" AlternateText="Admin Image" />
                            <div class="mt-2">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <asp:FileUpload ID="fuAdminPhoto" runat="server" />
                                <asp:RequiredFieldValidator ID="rfvAdminPhoto" runat="server"
                                    ErrorMessage="Select One Photo" CssClass="text-danger"
                                    ControlToValidate="fuAdminPhoto" SetFocusOnError="True"
